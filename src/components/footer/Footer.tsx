                        ...
                        <div >
                            ...
                            <div className='flex flex-col sm:flex-row lg:items-end pt-2'>
                                ...
                                <div className="flex justify-end">
                                    <button className='capitalize border border-solid border-white ml-2 rounded-full	px-2 py-1 text-white text-sm right-2 md:text-xs text-white hover:bg-white hover:text-black duration-500 mt-3 sm:-right-16 sm:-top-3 justify-end xs:ms-50' >Subscribe</button>
                                </div>
                            </div>
                        </div>
                        {/* icon email */}
