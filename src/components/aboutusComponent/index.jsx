...
export default function AboutUsComponent() {
  ...
  return (
    ...
    <main className=" px-4 ss:px-8 lg:px-16 inter mt-[60px] sm:mt-[100px] text-black mb-12">
      <div className="">
        <h1 className="rany text-[30px] font-medium ss:text-[50px] lg:text-7xl aboutus-title text-black">
          About us
        </h1>
        ...
        <h1 className='text-black text-[20px] ss:text-[30px] lg:text-4xl xl:text-5xl font-medium rany aboutus-set-title mt-[23px]' >
      ...
      <div>
        ...
        <div className=' sm:mt-[57px] mt-[30px] '>
          <h1 className={`text-black item rany text-[20px] ss:text-[30px] lg:text-4xl xl:text-5xl font-medium	${isVisible ? "fade-and-scroll-right-to-left" : ""
          ...
          <div className='sm:mt-[57px] mt-[30px] mb-[30px] '>
            <h1 className={`text-black item-delay2 rany text-[20px] ss:text-[30px] lg:text-4xl xl:text-5xl font-medium sm:italic ${isVisible ? "fade-and-scroll-right-to-left" : ""
              }`} ref={textContainerRef}>
              The people who <br />
