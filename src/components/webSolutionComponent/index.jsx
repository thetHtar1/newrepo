...
import img1 from "@/pages/assets/images/partner1.png"
  ...
  useEffect(() => {
    ...
    return(
        ...
        <div className="mt-[86px] sm:mt-[118px]">
            ...
            <p className="font-normal text-xs inter lg:text-lg websolution-p text-justify">
        ...
        <div className="mt-7 border-b-2 border-gray-400 pb-5">
            ...
            <p className="text-xs mt-2.5 md:text-base hidden ss:block web-body-p text-justify">
            ...
            <div className="mt-2.5  md:mt-[30px] web-bodyImg-div">
            <Image className={`web-bodyImg w-screen ${showImage ? 'show' : ''}`} src={img1} alt="web-solution-1"/>
            </div>
        ...
        <div className="mt-7 security-body">
            ...
            <div className="securtiy-body-items" ref={(ref) => (divRefs.current[1] = ref)} >
            <Image className="w-screen" src={img1} alt="web-solution-1"/>

           
            <p className="text-xs mt-2.5 md:text-base hidden ss:block items-security text-justify" >
            ...
            <p className="text-xs mt-2.5 md:text-base ss:hidden text-justify">
            Web hosting from Smilax Global gives you everything you need to get your website up and running in minutes. 
            The range of great value hosting packages that will fit your needs, no matter what size server capacity you require
             and provides a solution for personal websites, blogs and businesses of all sizes.
             Our servers are housed in a state-of-the-art data centre in United Kingdom and our service is backed by our technical support team.
