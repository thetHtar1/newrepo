...
import locationicon from  '@/pages/assets/images/location-icon.png'
import teleicon from '@/pages/assets/svg/tele.svg'
import emailicon from '@/pages/assets/svg/email.svg'
import Image from "next/image";
import ReCAPTCHA from "react-google-recaptcha";
import sendiocn from "@/pages/assets/svg/send.svg"
...
export default function ContactComponent (){
    ...
    return(
        ...
        <div className="mb-12  mt-[86px] sm:mt-[118px] ">
            ...
            <div className={`mb-4 sm:mt-[37px] border-y-4 border-black map-animation ${showMap ? 'show' : ''}`} >
            <iframe className="h-[204px] w-full sm:h-[549px]"
            ...
            <div className="flex flex-row justify-center px-4 sm:basis-[50%] contact-us-address">
                ...
                <div className="basis-[90%] sm:basic-[95%]">
            ...
            <div className={`contact-box  px-4 ss:px-8  sm:border-2 sm:border-black sm:px-[39px] sm:rounded-tr-3xl sm:rounded-bl-3xl sm:absolute sm:top-[45px]  
            ...
            <div className="mt-5 sm:mt-[50px]">
                <h1 className="inter italic text-xl font-semibold	">
                    Get in Touch
                </h1>
            </div>
{/* 
...
<form onSubmit={handleSubmit(onSubmit)} className="">
              <input
                id="name"
                placeholder="Name"
                className="placeholder-black font-medium text-[15px] w-full border-b-2 border-black pb-[15px] mt-2 sm:mt-[25px] outline-none"
              ...
              <input
                id="phone"
                placeholder="Phone"
                className="placeholder-black font-medium text-[15px] w-full border-b-2 border-black pb-[15px] mt-2 sm:mt-[25px] border-0 outline-none"
              ...
              <select
                ...
                className="placeholder-black font-medium text-[15px] w-full border-b-2 outline-none border-black
...
<div className="mt-[14px] sm:mt-[25px]">
  ...
  />
              ...
              <div className="flex justify-end mt-[25px] sm:mb-[48px]">
                <button
                  className="flex items-center gap-1 border-2 border-black rounded-full px-2 py-1"
                  type="submit"
                >
